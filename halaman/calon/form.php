<div class="row form-group">
	...
	<div class="col-lg-9">
		<input class="form-control" type="text" name="keluarga" placeholder="Keluarga" required="" value="<?php if(isset($data_calon)) echo $data_calon['keluarga']; ?>">
	</div>
</div>
    ...
    <div class="row form-group">
        ...
        <div class="col-lg-9">
            ...
            <?php if ($data[0]['nama_subkriteria']=='input'): ?>
                <input class="form-control" required type="number" name="value[<?php echo $data[0]['id']; ?>]" placeholder="<?php echo $data[0]['nama']; ?>" value="<?php if(isset($data_calon['kriteria'][$data[0]['nama']]['value'])) echo $data_calon['kriteria'][$data[0]['nama']]['value']; ?>">
                <input type="hidden" name="sub_id[<?php echo $data[0]['id'] ?>]" value="<?php echo $data[0]['subkriteria_id'] ?>">
 
            <?php else: ?>
                <select class="form-control" name="sub_id[<?php echo $data[0]['id'] ?>]" required>

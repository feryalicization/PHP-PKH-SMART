...
<head>
    ...
    <title>Sistem Pendukung Keputusan Penerima PKH</title>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <center>
                        <img src="asset/lg2.png" width="100%" alt="" srcset="">
                        <br><br>
                    </center>
                    </div>
                    <div class="panel-body">
                        <form action="config/proses_login.php" method="POST">
                            <fieldset>
                                ...
                                <hr>
                                <p class="text-center">Distributed By <strong>Syamsudin Hadi</strong> </p>
                            </fieldset>
                        </form>
                    </div>
                </div>

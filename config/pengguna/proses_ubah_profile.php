...
$sql_check = "SELECT * from pengguna where id=$id AND password='".$password_lama."'";
...
if(mysqli_num_rows(mysqli_query($koneksi, $sql_check))<1){
	...
	$sql_password = "UPDATE pengguna set nama='$nama', username='$username', password='$password_baru' where id=$id";
...
header('location:/smart/index.php?url=pengaturan');
